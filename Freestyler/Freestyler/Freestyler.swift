...
public class Freestyler {
    ...
    public static let shared = Freestyler()
    private init() {}
    ...
    func logStyle(_ style: NSObject, propertyMap: [String : Any]) {
        guard Freestyler.shared.logLevel == .info else { return }
        
        let setMessage = "Freestyler tries to set style named '\(style.classForCoder)' on \(String(describing: type(of: self)))."
